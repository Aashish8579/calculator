...
public class CalculatorApplication implements ActionListener {
    ...
    public void addComponents() {
        ...
        onRadioButton.setFont(new Font("Araial", Font.BOLD, 14));
        ...
        buttonDot.setFont(new Font("Araial", Font.BOLD, 20));
    ...
    public void addActionEvent() {
        onRadioButton.addActionListener(this);  // this button track action
